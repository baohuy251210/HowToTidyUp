...
#include <memory>
#include "../FinalProject/mainmenuscene.h"
...
QT_MOC_LITERAL(3, 23, 24), // "on_newGameButton_clicked"
QT_MOC_LITERAL(4, 48, 15) // "aShockingReveal"

    },
    "MainMenuScene\0hovered\0\0on_newGameButton_clicked\0"
    "aShockingReveal"
};
...
void MainMenuScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->aShockingReveal(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainMenuScene::hovered)) {
                *result = 0;
                return;
            }
        }
